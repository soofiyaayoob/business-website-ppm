...
function Connect() {
  ...
  return (
    <section
      className="bg-no-repeat bg-cover bg-center pt-16 text-white"
      id="contact"
      style={{
        backgroundImage:
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 con-custom justify-items-center">
        ...
        <div className="flex flex-col gap-3 lg:gap-10">
          ...
          <p className=" text-base leading-relaxed tracking-widest max-w-xl">
            We’re here to assist with pricing, availability, and delivery — send
        ...
        <form
          ...
          className="bg-white rounded-lg p-8 -mb-7 md:max-w-lg w-full shadow-lg border-b-[4.67px] border-b-[#115F85]"
        >
